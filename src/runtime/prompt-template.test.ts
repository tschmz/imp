...
describe("createPromptTemplateContext", () => {
  ...
  it("renders runtime date and time in prompt templates", () => {
    ...
    const rendered = renderPromptTemplate(
      "{{runtime.now.iso}} | {{runtime.now.date}} | {{runtime.now.weekday}} | {{runtime.now.time}} | {{runtime.now.timeMinute}} | {{runtime.now.local}} | {{runtime.now.localMinute}} | {{runtime.timezone}}",
      {
        filePath: "/workspace/SYSTEM.md",
        context,
      },
    ...
    expect(rendered).toBe(
      "2026-04-19T12:34:56.000Z | 2026-04-19 | Sunday | 14:34:56 | 14:34 | 2026-04-19 14:34:56 Europe/Berlin | 2026-04-19 14:34 Europe/Berlin | Europe/Berlin",
    );
  });
